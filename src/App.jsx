...
const WAFloat = () => {
  const handleClick = () => {
    const parts = ['87701785344'];
    const cc = '62';
    const num = cc + parts[0];
    const msg = encodeURIComponent('Halo Bang Bisnis! Mau konsultasi gratis dong.');
    window.open(`https://wa.me/${num}?text=${msg}`, '_blank', 'noopener,noreferrer');
  };
  return (
    <button className="wa-float" onClick={handleClick} title="Chat via WhatsApp" aria-label="Hubungi via WhatsApp">
